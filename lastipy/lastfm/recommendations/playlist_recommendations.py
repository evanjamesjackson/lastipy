...
def fetch_recommendations(
          ...
          user,
          api_key,
          max_similar_tracks_per_track=100,
          blacklisted_artists=[],
          prefer_unheard_artists=True):
    """Fetches recommendations by getting tracks similar to the given list, 
    and filtering out the given user's recent tracks and blacklisted artists"""
