...
class RatingCalculatorTest(unittest.TestCase):
    ...
    def test_rating_with_one_top_track_multiple_recommendations(self, mock_recent_artists):
        ...
        recommended_track_2 = RecommendedTrack(
            artist="The Beatles", track_name='Baby You\'re a Rich Man', recommendation_rating=1)
        recommended_track_3 = RecommendedTrack(
            artist="The Beatles", track_name="Blue Jay Way", recommendation_rating=1)
        top_tracks_to_recommendations = {
            top_track: [recommended_track_1,
                        recommended_track_2, recommended_track_3]
        }
        recommendations = calculate_ratings(
            'test', '', top_tracks_to_recommendations)
        self.assertEqual(10, recommendations[0].recommendation_rating)
    ...
    def test_rating_with_multiple_top_tracks_multiple_recommendations(self, mock_recent_artists):
        ...
        recommended_track_3 = RecommendedTrack(
            artist="The Beatles", track_name="Blue Jay Way", recommendation_rating=1)
        top_track_2 = TopScrobbledTrack(
            artist='The Rolling Stones', track_name='Satisfaction', playcount=20)
        recommended_track_4 = RecommendedTrack(
            artist='The Rolling Stones', track_name='Ruby Tuesday', recommendation_rating=1)
        recommended_track_5 = RecommendedTrack(
            artist="The Beatles", track_name='Get Off Of My Cloud', recommendation_rating=1)
        top_tracks_to_recommendations = {
    ...
    def test_reducing_based_on_recent_artists_ignores_case(self, mock_recent_artists):
        ...
        top_track = TopScrobbledTrack(
            artist='LANY', track_name='Some Whiny Crap', playcount=2)
