...
class TopRecommendationsFetcherTest(unittest.TestCase):
    def test_recent_tracks_are_filtered(self):
        ...
        recent_fetcher.fetch = MagicMock(return_value=[Track(track_name="While My Guitar Gently Weeps", artist="The Beatles")])
        ...
        similar_fetcher.fetch = MagicMock(return_value=[Track(track_name="While My Guitar Gently Weeps", artist="The Beatles"),
