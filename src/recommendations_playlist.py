...
class RecommendationsPlaylist:

    def __init__(self, recommendations_fetcher):
    ...
    def build_recommendations_playlist(self,
        ...
        weights = self._calculate_rating_weights(recommendations)
    ...
    def _calculate_rating_weights(self, recommendations):
        total_ratings = 0
